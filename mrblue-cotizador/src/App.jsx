          ...
          {papelInfo.sinPrecio ? (
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "6px 14px", alignItems: "start" }}>
              ...
              <div style={{ gridColumn: "1 / -1", fontSize: 10.5, color: C.muted }}>
                ...
                {papelInfo.marca ? <span style={{ color: C.cyan, fontWeight: 700 }}>{" · "}{papelInfo.marca}</span> : ""}
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1.2fr 1fr 1fr 1fr 1.1fr", gap: 8, marginBottom: 8 }}>
                <div>
                  ...
                  <input value={formMarca} onChange={e => setFormMarca(e.target.value)}
                    placeholder="Ej. Zenith" style={inputStyle} />
                </div>
                <div>
          ...
          <div key={s.id} style={{ background: C.bg, border: `1.5px solid ${C.border}`, borderRadius: 8, marginBottom: 10, overflow: "hidden" }}>
            ...
            {d.escalones.map((e, idx) => (
              <div key={idx} style={{ display: "grid",
                ...
                {esPapel && !esFijo && <>
                  <input value={e.marca} onChange={ev => updateEscalon(claveActiva, idx, "marca", ev.target.value)}
                    placeholder="Ej. Zenith" title="Marca o nombre comercial con que este proveedor lo vende"
